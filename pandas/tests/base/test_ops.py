...
class TestIndexOps:
    def test_none_comparison(self, index_or_series_obj):

        # bug brought up by #1079
        # changed from TypeError in 0.17.0
        o = index_or_series_obj
    ...
    def test_item_on_single_entry(self):
    ...
    def test_value_counts_unique_nunique_null(self, index_or_series_obj, null_obj):
    ...
    def test_factorize(self, index_or_series_obj):
        orig = index_or_series_obj
        o = orig.copy()
    ...
    def test_factorize_repeated(self, index_or_series_obj):
        orig = index_or_series_obj
        o = orig.copy()
    ...
    def test_duplicated_drop_duplicates_index(self, index_or_series_obj):
        # GH 4060
        original = index_or_series_obj
